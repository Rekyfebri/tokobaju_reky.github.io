    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-6 teks">
          <h2>OCTOBER'S ARRIVALS</h2>
          <h4>Shine Brgihter with Our New Arrival</h4>
          <button type="button" class="btn btn-secondary">Belanja sekarang</button>
        </div>
        <div class="col-md-6 nproduct">
          
            <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="img/pakaian1.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                  <img src="img/pakaian2.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                  <img src="img/pakaian3.jpg" class="d-block w-100" alt="...">
                </div>
              </div>
              <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="prev">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
    ...
    <div class="row product2">
     ...
     <div class="col-md-4">
       <div class="card bg-light">
        <img src="kategori/pakaian_bayi.jpg" class="card-img-top" alt="...">
        <div class="card-body">
     ...
     <div class="col-md-4">
       <div class="card bg-light">
          <img src="kategori/pakaian_dewasa.jpg" class="card-img-top" alt="...">
          <div class="card-body">
     ...
     <div class="col-md-4">
        <div class="card bg-light">
          <img src="kategori/pakaian_anak.jpg" class="card-img-top" alt="...">
          <div class="card-body">
